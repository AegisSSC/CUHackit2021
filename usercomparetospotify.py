...
class UserComparisonTool():
    ...
    def compare_playlists(self, user_score, spotify_playlist):
        delta_danceability = spotify_playlist[0] - user_score[0]
        delta_tempo = spotify_playlist[1] - user_score[1]
        delta_acousticness = spotify_playlist[4] - user_score[4]
        delta_speechiness = spotify_playlist[5] - user_score[5]
        delta_valence = spotify_playlist[6] - user_score[6]
        delta_energy = spotify_playlist[7] - user_score[7]
